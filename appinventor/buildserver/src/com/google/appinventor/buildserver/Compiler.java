...
public final class Compiler {
  ...
  private static final String DEFAULT_ICON = RUNTIME_FILES_DIR + "am.png";
...
//      if (!"Classic".equalsIgnoreCase(project.getTheme())) {
  ...
  public static boolean compile(Project project, Set<String> compTypes, Map<String, Set<String>> compBlocks,
    ...
    if (!compiler.prepareApplicationIcon(new File(drawableDir, "am.png"), mipmapDirectoriesForIcons, standardICSizesForMipmaps, foregroundICSizesForMipmaps)) {
      return false;
    }
    if (reporter != null) {
