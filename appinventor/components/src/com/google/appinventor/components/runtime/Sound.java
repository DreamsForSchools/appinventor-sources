...
@DesignerComponent(version = YaVersion.SOUND_COMPONENT_VERSION,
    description = "A multimedia component that plays sound " +
    ...
    "the Blocks Editor.</br></br>" + 
    "For supported sound file formats, see " +
    "<a href=\"http://developer.android.com/guide/appendix/media-formats.html\"" +
    " target=\"_blank\">Android Supported Media Formats</a>.</br></br>" +
    "This <code>Sound</code> component is best for short sound files, such as sound " +
    "effects, while the <code>Player</code> component is more efficient for " +
    "longer sounds, such as songs.</br></br>" +
    "You might get an error if you attempt to play a sound " +
    "immeditely after setting the source.",
