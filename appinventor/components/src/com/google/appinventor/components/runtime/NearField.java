...
@DesignerComponent(version = YaVersion.NEARFIELD_COMPONENT_VERSION,
    description = "Non-visible component to provide NFC capabilities.  " +
    "For now this component supports the reading and writing of text tags only " +
    "(if supported by the device)</br></br>" +
    "In order to read and write text tags, the component must have its " +
    "<code>ReadMode</code> property set to True or False respectively.</br></br>" +
    "<strong>Note:</strong> This component will only work on Screen1 of" +
