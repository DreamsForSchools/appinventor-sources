...
// Messages from replmgr.js
    ...
    Blockly.Msg.REPL_CONNECT_TO_COMPANION = "Connect to the DFS AppMaker Companion";
    Blockly.Msg.REPL_TRY_AGAIN1 = "Failed to Connect to the DFS AppMaker Companion, try again.";
