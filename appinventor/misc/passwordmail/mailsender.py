...
templates = { 'en' : '''From: DFS - AppMaker System <appinventor@mit.edu>
To: %s
Subject: Password Reset for you DFS - AppMaker Account

You have requested a new password for your DFS - AppMaker Account.
