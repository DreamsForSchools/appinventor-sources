...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("Your app \"{0}\" has been removed from the gallery due to inappropriate content. "
          + "Please review the guidelines at https://docs.google.com/document/d/1F0SiDEAi9aBsrkqSzSQr4gUD2eJHCB_w-hrQXWjEf48/preview. "
  ...
  @DefaultMessage("Welcome to DFS AppMaker!")
  ...
  @DefaultMessage("Create a new DFS AppMaker project")
  ...
  @DefaultMessage("Name this DFS AppMaker project")
  ...
  @DefaultMessage("You do not have any projects in DFS - AppMaker. " +
  ...
  @DefaultMessage("<h2>Please fill out a short voluntary survey so that we can learn more about our users and improve DFS AppMaker.</h2>")
  @Description("")
